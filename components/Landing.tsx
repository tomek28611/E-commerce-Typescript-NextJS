    ...
    justify-between px-8'>
        <div className='space-y-8'>
            ...
            lg:text-6xl xl:text-7xl">
                <span className="block bg-gradient-to-r from-pink-500 to-violet-600
                bg-clip-text text-transparent">Powered</span>
        ...
        md:inline lg:h-[650px] lg:w-[600px]">
            <Image src="/iphone.png" layout="fill" objectFit="contain" width={450} 
            height={450}  />
        </div>
    </section>
  )
